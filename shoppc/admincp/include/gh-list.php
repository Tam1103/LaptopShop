...
<form method="post">
  ...
  <tr height="30" bgcolor="#ffcc99">
		...
		<!--<td align="center" width="150" style="border-right:1px solid #333"><strong>Chi tiết</strong></td> --> 		
  </tr>
  <?php
...
?>
     <tr height="30">
        ...
        <td align="center" width="140" style="border-right:1px solid #333; border-bottom:1px solid #333;"><strong><a onmouseover="Tip('<?php echo "Họ tên: $hoten<hr>Địa chỉ: $diachi<hr>Email: $email<hr>Điện thoại: $t"; ?>')" onclick="var win=window.open('chitietthanhvien.php?hoten=<?php echo $hoten; ?>', 'open_window', 'width=570, height=320, left=0, top=0')"><?php echo "$hoten";?></a></strong></td>
		...
		<!--<td align="center" width="150" style="border-right:1px solid #333; border-bottom:1px solid #333;" onclick="var win=window.open('chitietthanhvien.php?hoten=<?php echo $hoten; ?>', 'open_window', 'width=570, height=320, left=0, top=0')">Xem chi tiết</td> 	-->	
      </tr>  
