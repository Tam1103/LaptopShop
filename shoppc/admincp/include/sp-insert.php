	<?php
include "../connect.php";
$mota="";$gia="";$soluongban="";$tensp="";$ghichu="";
if(isset($_POST["act"]))
{//(1)
	$loaisp=$_POST["loaisp"];
	...
	{//(3)
		...
		$sql="insert into sanpham(id,id_loai,tensp,mota,hinh,gia,soluongban,ghichu) values ('$id',$loaisp,'$tensp','$mota','$newName','$gia','$soluongban','$ghichu')";}
//	echo "$sql<hr>";
	$kq=mysql_query($sql);
	if(!$kq){
