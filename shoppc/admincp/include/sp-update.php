...
//	echo "$name - $new<hr>";
	...
	{	
		if($id2!=$id){
			$sql5="UPDATE sanpham SET id='$id2', id_loai='$loaisp', tensp='$tensp', mota='$mota', gia='$gia',soluongban='$soluongban',ghichu='$ghichu',hinh='$new',id_menu='$menu' WHERE id='$id'";
			...
			$sql3="UPDATE sanpham SET id='$id2', id_loai='$loaisp', tensp='$tensp', mota='$mota', gia='$gia',ghichu='$ghichu',soluongban='$soluongban',id_menu='$menu' WHERE id='$id'";
		...
		unlink("../sanpham/large/$name");
			...
			//********************************resize hinh ********************************
		$sql4="UPDATE sanpham SET id='$id2', id_loai='$loaisp', tensp='$tensp', mota='$mota',hinh='$newName', gia='$gia',ghichu='$ghichu',soluongban='$soluongban',id_menu='$menu' WHERE id='$id'";
...
<?php
	...
	else 
	{
		...
		$gia=$r["gia"];$ghichu=$r["ghichu"];$soluongban=$r["soluongban"];
		$id_menu=$r["id_menu"];
	//	echo "$id_loai";
?>
...
<img align="middle" src="/sanpham/small/<?php echo "$hinh"; ?>" width="80" height="80">
 <input type="hidden" name="oldimage" value="<?php echo "$hinh"; ?>"> 
  ...
  <tr bgcolor="#FFFFFF">
    ...
    <td><input name="soluongban" type="text" maxlength="20" style="width:240px" value="<?php echo "$soluongban"; ?>"></td>
  </tr>
  <tr>
