...
<form id="login-form" method="POST" action="login-authentication.php">
   <fieldset>
			...
			<h1><font color="#FFFFFF"><center>Đăng nhập quản trị</center></font></h1>
			<center><table width="304" border="0" >
			  ...
			  <tr >
			    <td>&nbsp;</td>
			    <td><input name="input" type="reset" value="Đặt lại"/>			 
				<input type="submit"  class="button" name="commit" value="Đăng nhập"/></td>
		      </tr>
     </table>
