...
<table width="560" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    <td width="220" rowspan="8" align="center" valign="top"><div onclick="var win=window.open('zoom.php?id=<?php echo $id; ?>', 'open_window', 'width=405, height=530, left=0, top=0')">
	...
	<tr>
    <td width="120" height="25" style="padding-left:20px; border-bottom:1px dotted #666; border-right:1px dotted #666">Số lượng còn:</td>
    <td width="220" style="border-bottom:1px dotted #666; padding-left:5px"><span style="font-size:18px; color:#f00"><?php echo $soluongban; ?></span></td>
	</tr>
  <tr>
...
thanh toán:</td>
    <td style="border-bottom:1px dotted #666; padding-left:5px">Nhận tiền sau khi giao hàng</td>
  </tr>
