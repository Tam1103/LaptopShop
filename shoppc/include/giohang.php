...
//		  echo "$count<hr>";
	...
	//	 $hinh = "images_data/".$dong["hinh"];
          ...
          echo "<tr align=\"center\" height=\"30\" >
            ...
            <input type=\"text\" name=\"sl\" value='$sl' style=\"width:30px\" onkeyup=\"valid(this,'numbers')\" onblur=\"valid(this,'numbers')\" ><font color=\"#FF0000\"> </font> 
            </td></form>
...
function dathang($gh,$hoten,$diachi,$email,$dt,$fax,$cty,$now)
{
  ...
  foreach($gh as $id=>$sl)
  {	  	
  	   $sql5="select * from sanpham where id='$id'";
	...
	if($sl > $sl5)
						echo "<script>alert('Số lượng bán không đủ. Xin quý khách mua dưới $sl5 sản phẩm');</script>" ;
