...
<form method="post" name="form">
  ...
  <tr bgcolor="#ad2200" align="center" height="30" style="font-weight:bold">
    ...
    <td width="50" ><font color="#FFFFFF">Chọn</font></td>                
  </tr>
  <?php   
  	$user=$_SESSION["user"];	
...
?>			
 ...
 <?php			
	...
	if(mysql_num_rows($kq)==0)
		...
		echo "<tr>
  <td height=30 colspan=6 align=right style=\"padding-right:5px; padding-bottom:5px; color:#f00\">Tổng số tiền phải thanh toán: $tt </td></tr>
  <tr>
